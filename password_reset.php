...
if(isset($_POST['reset'])){
	...
	$passwordResetObj = new adminCrudClass();
	
	$passwordResetObj->resetPassword($_POST);
					...
					<div class="row">
						<div class="col-md-8 ">
							<div class="box">
								...
								<form action="password_reset.php" name ="username" method="POST" role="form">
									...
									<button type="submit" name = "reset" class="btn btn-primary btn-inline">Reset Password</button>&nbsp; &nbsp; &nbsp; 
