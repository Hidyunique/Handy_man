...
<div class="container-fluid" style="font-size: 15px;"> 
			...
			<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<!-- Job Form -->
							<form action="post_job.php" method="post" id="submit-job-form" class="job-manager-form" enctype="multipart/form-data">

								
								<fieldset>
									<label>Post a Job <span class="required"></span></label>
								...
								<div class="col-md-4">
										<fieldset class="fieldset-job_category">
											<label for="job_category">Deadline</label>
											<label for="job_type">Day</label>
											<div class="field select-style">

												<select name="day"id="job_type" class="form-control">
					              ...
					              <div class="col-md-4">
										<fieldset class="fieldset-job_category">
											...
											<label for="job_type">Month</label>
											<div class="field select-style">

												<select name="month"id="job_type" class="form-control">
									...
									<fieldset class="fieldset-job_category">
										<label for="job_category"> .</label>
										<label for="job_type">Year</label>
										<div class="field select-style">

											<select name="year"id="job_type" class="form-control">
								                <option value="2019" selected="1">2019</option>
								...
								<div class="row">
									<div class="col-md-12">
										<fieldset class="fieldset-application">
											...
											<div class="field">
												<input type="text" class="form-control" name="emailURL" id="application" placeholder="Enter an email address or website URL" />
											</div>
										</fieldset>
									</div>
								</div>			
