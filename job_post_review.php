...
//echo $_SESSION['userType']; die();
	...
	include('classes/adminCrud.php');
	 ...
	 $recs = $viewJobObj->viewJobs();
		...
		$viewJobObj = new adminCrudClass();
	 	$recs = $viewJobObj->viewAdminJobs($_SESSION['id'], $_SESSION['userName']);
									 ...
									 //    echo"data<pre>";
										...
										// echo"</pre>";
										 foreach($recs as $row){
											...
											echo "<tr>
													<td class='job_title'>
														<a href='#' class='job_title_link'>{$row['title']}</a>
											...
											<li><a onclick=\"deleteConfirm({$row['id']})\" href='#' >Delete</a></li>
													...
													<td class='date'>{$row['posted_date']}</</td>
													<td class='status'><div class=''><a onclick ='approveStatus({$row['id']})' href='#'> {$row['status']}</a></div></td>
													<td class='expires'>{$row['deadline']}</td>
													<td class='filled'><a onclick='filledStatus({$row['id']})' href='#'> {$row['filled']} </a></td>
													</tr>";
