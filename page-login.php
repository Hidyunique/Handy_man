<?php
	...
	if($_SESSION['userName'] != ""){
		...
		header("refresh:0; url=admin.php"); //die;
	}

include_once("classes/adminCrud.php");
if(isset($_POST['login'])){
	$loginObj = new adminCrudClass();
...
if(isset($_POST['register'])){
	...
	$empObj =  new adminCrudClass();

	$empObj->createEmployer($_POST);
}
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="box">
								<h3>Login</h3>
								<form action="page-login.php" name ="login" method="POST" role="form">
								...
								<form action="#" method="POST" role="form">
									...
									<!-- <div class="row">
										<div class="col-md-4">
											<div class="form-group">
												<label>
													Date Registered <span class="required">*</span>
												</label>
												<input type="password" name="password" class="form-control">
											</div>
										</div>
