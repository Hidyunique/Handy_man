...
//echo $_GET['userName']; die();
	...
	include('classes/adminCrud.php');
	 ...
	 $viewJobObj = new adminCrudClass();
	 $recs = $viewJobObj->viewJobs($jobId);

	}
	 	$id 		=   $recs[0]['id'];
		$title 		=	$recs[0]['title'];
		$location 	=	$recs[0]['location'];
		$job_type	= 	$recs[0]['job_type'];
		$category 	=	$recs[0]['category'];
		$description=	$recs[0]['description'];
		$email_url 	=	$recs[0]['email_url'];
		$posted_date=	$recs[0]['posted_date'];
		$deadline 	=	$recs[0]['deadline'];
		$status 	=	$recs[0]['status'];
		$filled 	=	$recs[0]['filled'];
...
<div class="container-fluid" style="font-size: 15px;"> 
		    <div class="main"  style="float: left; display: inline;">
		        ...
		        <?php 
		        	...
		        	if($_SESSION['id'] !=1 && $_SESSION['userType'] != 3 ){	        		
						...
						<div>
							...
							<table class="job-manager-jobs table table-bordered table-striped">
								...
								<tbody>
										...
										<tr>
											<td class='job_title'> ID</td>
											<td class='job_title'><?=$id?></td>
										</tr>
										<tr>
											<td class='job_title'>Title</td>
											<td class='job_title'><?=$title?></td>
										</tr>
										<tr>
											<td class='job_title'> Type</td>
											<td class='job_title'><?=$job_type?></td>
										</tr>
										<tr>
											<td class='job_title'>Category</td>
											<td class='job_title'><?=$category ?></td>
										</tr>
										<tr>
											<td class='job_title'>Type</td>
											<td class='job_title'><?=$description?></td>
										</tr>
										<tr>
											<td class='job_title'>Email</td>
											<td class='job_title'><?=$email_url?></td>
										</tr>
										<tr>
											<td class='job_title'>Posted Date</td>
											<td class='job_title'><?=$posted_date?></td>
										</tr>
										<tr>
											<td class='job_title'>Expire Date</td>
											<td class='job_title'><?=$deadline?></td>
										</tr>
										<tr>
											<td class='job_title'>Status
												<a href='#' class='job_title_link'></a>
												<ul class='job-dashboard-actions'>
													<li><a href='view_job.php?{$row['id']}' class='job-dashboard-action-edit'>Approve</a></li>
													<li><a href='#' class='job-dashboard-action-mark_filled'>Decline</a></li>
													
												</ul>
											</td>
											<td class='job_title'><?=$status?></td>
										</tr>
										<tr>
											<td class='job_title'>Filled
												<a href='#' class='job_title_link'></a>
												<ul class='job-dashboard-actions'>
													<li><a href='view_job.php?{$row['id']}' class='job-dashboard-action-edit'>Closed</a></li>
													
												</ul>
											</td>
											<td class='job_title'><?=$filled?></td>
										</tr>
