...
//echo $_GET['userName']; die();
	...
	include('classes/adminCrud.php');
	 ...
	 $viewAminDetailsObj = new adminCrudClass();
	 $recs = $viewAminDetailsObj->viewAdmin($adminId);

	}
	 	$id 				=   $recs[0]['id'];
		$company_name 		=	$recs[0]['company_name'];
		$firstname 			=	$recs[0]['firstname'];
		$surname			= 	$recs[0]['surname'];
						...
						<div>
							...
							<table class="job-manager-jobs table table-bordered table-striped">
								...
								<tbody>
										...
										<tr>
											<td class='job_title'>Company Name</td>
											<td class='job_title'><?=$company_name?></td>
										</tr>
										<tr>
											<td class='job_title'> Firstname</td>
											<td class='job_title'><?=$firstname ?></td>
										</tr>
										<tr>
											<td class='job_title'>Surname</td>
											<td class='job_title'><?=$surname ?></td>
										</tr>
										<tr>
											<td class='job_title'>Username</td>
											<td class='job_title'><?=$username?></td>
										</tr>
										<tr>
											<td class='job_title'>Address</td>
											<td class='job_title'><?=$address?></td>
										</tr>
										<tr>
										...
										<tr>
											<td class='job_title'>Phone</td>
											<td class='job_title'><?=$phone?></td>
										</tr>
										<tr>
											<td class='job_title'>Signup Date</td>
											<td class='job_title'><?=$date?></td>
										</tr>
										<tr>
